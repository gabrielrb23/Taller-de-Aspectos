...
public class AspectoNota {
    ...
    private static final Logger logger = Logger.getLogger(AspectoNota.class.getName());
    ...
    public void verificarPermisos(JoinPoint joinPoint) throws Throwable {
        ...
        if ("ROLE_ESTUDIANTE".equals(rol)) {
            if (!metodoHttp.equals("GET")) {
                ...
                throw new SecurityException("Los estudiantes solo pueden consultar sus notas.");
            }
